...
class GifCommands(commands.Cog):
    ...
    async def dance(self, ctx):
        gif_url = "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExbG5sa2psaDM3MXA2cTg4aXYyNmFhZW92Ym9iYzBjM2ttNWk3cjUzOCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/M8kTFe827hE6c8GeN9/giphy.gif"  # Replace with your desired dance GIF link
        await ctx.send(gif_url)
